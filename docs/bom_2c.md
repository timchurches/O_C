...
- the footprint for passives is **0805 throughout**, except the five 10n caps (0603). using 0603 everywhere will work just as fine, of course.
...
| 1x7 (1x8) OLED socket | 1x | 2.54mm, **low profile** but **not** "machined" sockets with round holes for the pins - the square header pins on most OLED carrier boards will not fit sockets with round holes. Use the low-profile sockets indicated here, or equivalent -> | e.g mouser # 517-929870-01-08-RA | 
